...
export default {
    ...
    argTypes: {
        onClickedOutside: {
            ...
            description: "The event emitter when the user click outside the menu"
        },
        onMenuItemClicked: {
            action: "onMenuItemClicked",
        ...
        menuItems: {
            ...
            defaultValue: [
                ...
                },
                {
                    ...
                    type: "item",
                    text: "Settings",
                    "icon data": `<svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const Template  = (args:any) => ({
    ...
    on: {
        ...
        onMenuItemClicked: args.onMenuItemClicked
    }
})
