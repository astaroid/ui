import CheckboxInput from "../../lib/component/checkbox-input.svelte"

export default {
    title: "Component/Input component/Checkbox Input",
    ...
    argTypes: {
        ...
        disabled: {
            ...
            defaultValue: false,
            control: { type: "boolean" },
            description: "If true the switch input is disabled"
        }
    }
}
