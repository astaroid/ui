...
export default {
    ...
    argTypes: {
        ...
        id: {
            ...
            control: { type: "text" },
            defaultValue: "Menu-item-001",
            description: "The unique identification of the menu item"
        },
        iconData: {
            name: "icon data",
            type: { name: "string" },
            control: { type: "text" },
            defaultValue: `<svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            description: "The svg text of the menu item icon"
        },
        type: {
            type: { name: "string" },
        ...
        color: {
            type: { name: "text" },
            control: { type: "color" },
            description: "The color of menu item",
        },
        disabled: {
            type: { name: "boolean" },
...
export const DarkItem = Template.bind({})
DarkItem.args = {
    theme: "dark"
}
DarkItem.parameters = {
